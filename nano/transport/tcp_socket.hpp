...
public:
	...
	explicit tcp_socket (transport_context &, socket_endpoint = socket_endpoint::client);

	/** Construct from an existing (connected) socket */
	tcp_socket (transport_context &, asio::ip::tcp::socket, socket_endpoint = socket_endpoint::server);
