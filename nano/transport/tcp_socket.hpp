...
public:
	...
	explicit tcp_socket (asio::io_context &, nano::transport::tcp_config const &, nano::stats &, nano::logger &, nano::transport::socket_endpoint = socket_endpoint::client);

	/** Construct from an existing (connected) socket */
	tcp_socket (asio::io_context &, nano::transport::tcp_config const &, nano::stats &, nano::logger &, asio::ip::tcp::socket, nano::transport::socket_endpoint = socket_endpoint::server);
