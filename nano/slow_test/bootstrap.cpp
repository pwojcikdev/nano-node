...
TEST (bootstrap, profile_topo)
{
	...
	flags_server.generate_cache.consistency_check = false;
	auto data_path_server = nano::working_path (network);
	auto server = std::make_shared<nano::node> (data_path_server, config_server, system.work, flags_server);
	system.nodes.push_back (server);
	server->start ();
	...
	rate.observe (*client, nano::stat::type::bootstrap, nano::stat::detail::blocks, nano::stat::dir::in);
	rate.observe (*client, nano::stat::type::bootstrap_topo, nano::stat::detail::next_topo_index);
	rate.observe (*client, nano::stat::type::bootstrap_topo, nano::stat::detail::next_topo_block);
	rate.observe (*client, nano::stat::type::bootstrap_topo, nano::stat::detail::process);
	rate.observe (*client, nano::stat::type::bootstrap_topo, nano::stat::detail::received);

	rate.observe (*client, nano::stat::type::block_processor_result, nano::stat::detail::progress);
	rate.observe (*client, nano::stat::type::block_processor_result, nano::stat::detail::old);
	rate.observe (*client, nano::stat::type::block_processor_result, nano::stat::detail::gap_epoch_open_pending);
	rate.observe (*client, nano::stat::type::block_processor_result, nano::stat::detail::gap_source);
	rate.observe (*client, nano::stat::type::block_processor_result, nano::stat::detail::gap_previous);
