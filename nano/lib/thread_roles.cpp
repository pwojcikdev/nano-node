...
std::string nano::thread_role::get_string (nano::thread_role::name role)
{
	...
	switch (role)
	{
		...
		case nano::thread_role::name::aec_notifications:
			...
			break;
		case nano::thread_role::name::aec_cemented_notifications:
			thread_role_name_string = "AEC cement";
			break;
		case nano::thread_role::name::aec_lifecycle_notifications:
			thread_role_name_string = "AEC lifecycle";
			break;
		case nano::thread_role::name::aec_workers:
			thread_role_name_string = "AEC workers";
			break;
