...
namespace websocket
{
	...
	public:
		...
		message block_confirmed (nano::stored_block const & block, nano::account const & account, nano::amount const & amount, std::string subtype, nano::election_status const & election_status, std::vector<nano::vote_with_weight_info> const & election_votes, nano::websocket::confirmation_options const & options);
	...
	public:
		...
		void broadcast_confirmation (nano::stored_block const & block, nano::account const & account, nano::amount const & amount, std::string const & subtype, nano::election_status const & election_status, std::vector<nano::vote_with_weight_info> const & election_votes);
