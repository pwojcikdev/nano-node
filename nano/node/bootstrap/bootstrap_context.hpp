...
public: // Strategies
	std::unique_ptr<priority_strategy> priority_strat_impl;
	priority_strategy & priority_strat;
	std::unique_ptr<database_strategy> database_strat_impl;
	database_strategy & database_strat;
	std::unique_ptr<dependency_strategy> dependency_strat_impl;
	dependency_strategy & dependency_strat;
	std::unique_ptr<frontier_strategy> frontier_strat_impl;
	frontier_strategy & frontier_strat;

public: // Shared state
	account_sets_index accounts;
	database_scan_index database_scan;
	frontier_scan_index frontiers;
