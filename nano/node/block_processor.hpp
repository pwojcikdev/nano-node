...
public:
	...
	std::optional<nano::block_status> add_blocking (nano::raw_block const & block, nano::block_source);
...
private:
	...
	void rollback_competitor (secure::write_transaction &, nano::raw_block const & block);
	nano::block_status process_one (secure::write_transaction const &, nano::block_context &, bool forced = false);
