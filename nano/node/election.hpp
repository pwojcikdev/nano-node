...
{
	// Complete instruction for broadcasting our vote via the vote generator
...
private:
	...
	// Decide whether to broadcast a vote for the current winner, final if reached quorum or already confirmed
	std::optional<nano::election_actions::vote_broadcast> decide_vote_locked (std::chrono::steady_clock::time_point now);
