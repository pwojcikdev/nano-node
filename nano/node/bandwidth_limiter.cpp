...
nano::rate_limiter_mt & nano::bandwidth_limiter::select_limiter (nano::transport::traffic_type type)
{
	switch (type)
	{
...
nano::rate_limiter_mt const & nano::bandwidth_limiter::select_limiter (nano::transport::traffic_type type) const
{
	switch (type)
	{
		case nano::transport::traffic_type::bootstrap_server:
