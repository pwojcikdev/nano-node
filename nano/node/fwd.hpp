...
class vote_relay;
class vote_relay_config;
class vote_relay_index;
class vote_relay_client;
class vote_relay_client_config;
...
class vote_solicitor_config;
class vote_solicitor_round;
class relay_rep_selector;
class vote_spacing;
class voting_policy;
