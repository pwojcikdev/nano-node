...
int main (int argc, char * const * argv)
{
	...
	description.add_options ()
		...
		("benchmark_multi_node_pipeline", "Run multi-node pipeline benchmark with configurable representatives")
		...
		("num_representatives", boost::program_options::value<std::string> (), "Defines number of representative nodes for multi-node benchmark (default 3)")
		("num_non_representatives", boost::program_options::value<std::string> (), "Defines number of non-representative nodes for multi-node benchmark (default 2)")
	...
	if (ec == nano::error_cli::unknown_command)
	{
		...
		else if (vm.count ("benchmark_multi_node_pipeline"))
		{
			nano::cli::run_multi_node_pipeline_benchmark (vm, data_path);
		}
