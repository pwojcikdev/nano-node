...
int main (int argc, char * const * argv)
{
	...
	description.add_options ()
		...
		("throughput_benchmark", "Run block processing throughput benchmark with configurable account pool (only for nano_dev_network)")
	...
	if (ec == nano::error_cli::unknown_command)
	{
		...
		else if (vm.count ("throughput_benchmark"))
		{
			nano::run_throughput_benchmark (vm, data_path);
		}
