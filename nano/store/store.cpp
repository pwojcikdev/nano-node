...
ledger_store::ledger_store (std::unique_ptr<nano::store::backend> backend_a, nano::store::open_mode mode, nano::stats & stats_a, nano::logger & logger_a, ledger_store_params params) :
	...
	block_impl{ std::make_unique<nano::store::ledger::block> (*backend_impl) },
	account_impl{ std::make_unique<nano::store::ledger::account> (*backend_impl) },
	pending_impl{ std::make_unique<nano::store::ledger::pending> (*backend_impl) },
	rep_weight_impl{ std::make_unique<nano::store::ledger::rep_weight> (*backend_impl) },
	online_weight_impl{ std::make_unique<nano::store::ledger::online_weight> (*backend_impl) },
	pruned_impl{ std::make_unique<nano::store::ledger::pruned> (*backend_impl) },
	peer_impl{ std::make_unique<nano::store::ledger::peer> (*backend_impl) },
	confirmation_height_impl{ std::make_unique<nano::store::ledger::confirmation_height> (*backend_impl) },
	final_vote_impl{ std::make_unique<nano::store::ledger::final_vote> (*backend_impl) },
	version_impl{ std::make_unique<nano::store::ledger::version> (*backend_impl) },
