...
TEST (ledger_upgrades, upgrade_v24_to_v25_topology_index)
{
	...
	auto open_a = nano::block_builder ()
				  ...
				  .work (0)
				  .build ();
	open_a->sideband_set (nano::block_sideband{ key1.pub, 0, 100, 1, nano::seconds_since_epoch (), nano::epoch::epoch_0, false, false, false, nano::epoch::epoch_0 });
	...
	auto change_a = nano::block_builder ()
					...
					.work (0)
					.build ();
	change_a->sideband_set (nano::block_sideband{ key1.pub, 0, 100, 2, nano::seconds_since_epoch (), nano::epoch::epoch_0, false, false, false, nano::epoch::epoch_0 });
	...
	auto open_b = nano::block_builder ()
				  ...
				  .work (0)
				  .build ();
	open_b->sideband_set (nano::block_sideband{ key2.pub, 0, 50, 1, nano::seconds_since_epoch (), nano::epoch::epoch_0, false, false, false, nano::epoch::epoch_0 });
	...
	auto open_c = nano::block_builder ()
				  ...
				  .work (0)
				  .build ();
	open_c->sideband_set (nano::block_sideband{ key3.pub, 0, 10, 1, nano::seconds_since_epoch (), nano::epoch::epoch_0, false, false, false, nano::epoch::epoch_0 });
	...
	auto order_open_a = upgraded_open_a->sideband ().topology;
	auto order_change_a = upgraded_change_a->sideband ().topology;
	auto order_open_b = upgraded_open_b->sideband ().topology;
	auto order_open_c = upgraded_open_c->sideband ().topology;
	...
	ASSERT_EQ (i->first.index, order_open_a);
